...
![Screenshot of the introduction](assets/documentation/game-introduction.png)

![Screenshot of the name prompt](assets/documentation/type-blank-name.png)
...
![Screenshot of the game instructions](assets/documentation/game-instructions.png)

![Screenshot of the aye, nay, invalid](assets/documentation/aye-nay-invalid.png)

![Screenshot of user selecting nay](assets/documentation/user-nay.png)

![Screenshot of user selecting aye](assets/documentation/user-aye.png)
...
![Screenshot of the y or no invalid](assets/documentation/y-n-invalid.png)

![Screenshot of user first coordinate typing](assets/documentation/user-place-ships-y.png)

![Screenshot of invalid letter](assets/documentation/invalid-letter-coord.png)

![Screenshot of A 1 coordinates](assets/documentation/user-place-ships.png)

![Screenshot of the invalid number](assets/documentation/invalid-number-coord.png)

![Screenshot of redundant coordinate](assets/documentation/user-redundant-coordinate-place-ships.png)

![Screenshot of finished coordinates](assets/documentation/user-place-ships-complete.png)
...
![Screenshot of user's randomized coordinates](assets/documentation/user-randomize-coord.png)
...
![Screenshot of coin toss user wins](assets/documentation/coin-toss-user.png)

![Screenshot of coin toss computer wins](assets/documentation/coin-toss-computer.png)
...
![Screenshot of user getting hit](assets/documentation/user-gets-hit.png)

![Screenshot of computer missing](assets/documentation/enemy-misses.png)
...
![Screenshot of first try](assets/documentation/user-first-try.png)

![Screenshot of inputting coordinates](assets/documentation/user-types-coordinates.png)

![Screenshot of user hitting same spot](assets/documentation/user-hits-same-spot.png)

![Screenshot of user hits ship](assets/documentation/computer-gets-hit.png)

![Screenshot of user missing](assets/documentation/user-misses.png)
...
![Screenshot of user winning](assets/documentation/user-wins.png)

![Screenshot of computer winning](assets/documentation/computer-wins.png)
